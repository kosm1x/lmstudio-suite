// Bundled by lmstudio-suite (scripts/package-plugins.mjs) from packages/plugin-web. Do not edit; regenerate instead.
...
// packages/plugin-web/src/config.ts
...
var globalConfigSchematics = createConfigSchematics().field(
  ...
  "boolean",
  {
    ...
    warning: "Enabling this lets the model fetch loopback/internal URLs, including across redirects."
  },
  false
).build();
